...
export default function ElectricityCostSlider({
    ...
    return (
        <div className="group rounded-xl bg-gradient-to-br from-white to-yellow-50 p-6 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-slate-800 dark:to-slate-900">
            <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="rounded-lg bg-gradient-to-br from-yellow-500 to-amber-600 p-2 shadow-md">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="rounded-lg bg-gradient-to-r from-yellow-500 to-amber-600 px-4 py-2 shadow-md">
                        <div className="flex flex-col items-end">
                            <span className="text-sm  text-white">
                                {electricityCost.toLocaleString('en-US')}                میلیون تومان
            ...
            <div className="relative">
                ...
                {/* Filled track (yellow) - از راست به چپ */}
                <div
                    className="absolute top-0 right-0 h-4 rounded-full bg-gradient-to-r from-yellow-500 to-amber-600 pointer-events-none shadow-lg transition-all duration-300"
                    style={{
                        width: `${percentage}%`,
                    }}
                />
                {/* نشانگر مقدار پیش‌فرض */}
                {initialElectricityCost > 0 && (
                    <div
                        ...
                        title={`مقدار پیش‌فرض: ${initialElectricityCost.toLocaleString('en-US')}`}
                    >
